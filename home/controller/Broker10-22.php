...

{
...

    {
        ...
        $field = 'u.id,u.nick_name,u.mobile,u.lxtel,u.description,d.service_area,d.company,d.tags,d.point,(FORMAT((d.point/5)*100,0)) as goods';
...

    {
...

        {
            ...
            $field = 'id,title,fcstatus,estate_name,img,room,living_room,toilet,acreage,price,average_price,address,orientations,renovation,tags';
