...
//				
...

    {
        ...
        $field   = "s.id,s.title,s.estate_name,s.video,s.img,s.pano_url,s.room,s.living_room,s.toilet,s.price,s.average_price,s.tags,s.address,s.acreage,s.orientations,s.renovation,s.user_type,s.contacts,s.update_time,s.jieduan,s.fcstatus,s.types";
