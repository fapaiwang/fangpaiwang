    ...
    private function getLists($page = 0)
    {
      ...
      //   }
			...
			if($page)
        {
			...
			//echo 123;
            // print_r($page);exit();
            $lists = $obj->where('fcstatus','eq',175)->page($page)->limit($this->pageSize)->order(['endtime'=>'desc'])->select();
      ...
      print_r(11111);
			...
			//echo 345;
print_r(2222222);
            $result = $obj->where('fcstatus','eq',175)->order('endtime','desc')->paginate($this->pageSize);
