...

{
    ...
    {
        $list=model('second_house')->order(['fabutime'=>'desc'])->select();
        // foreach ($list as $key => $value) {
             

        //     $list[$key]['kptimes']=strtotime($list[$key]['kptime']);
        //     $list[$key]['bianetimes']=strtotime($list[$key]['bianetime']);
        //     $sTime=time();
        //     // print_r($lists[$key]['fcstatus']);
        //     if($list[$key]['fcstatus']==169 || $list[$key]['fcstatus']==170 || $list[$key]['fcstatus']==171){

        //         $ctimes=$sTime-$lists[$key]['kptimes'];

        //         // print_r($lists[$key]['jieduan']);
        //         if($list[$key]['jieduan']==163){
        //         $ctimess=$sTime-$list[$key]['bianetimes'];
        //         if($ctimes>=0){
        //             //当前时间-开拍时间
        //             if($ctimess >= 0){
        //             model('second_house')->where(['id'=>$list[$key]['id']])->update(['fcstatus'=>171]);//正在进行169
        //             // print_r($ctimes);echo "aaa";
        //             }else{
        //             model('second_house')->where(['id'=>$list[$key]['id']])->update(['fcstatus'=>169]);//已结束171
        //              // print_r($ctimes);echo "aaa";
        //             }
        //             // else{
        ...
        //         }else{
        //             model('second_house')->where(['id'=>$list[$key]['id']])->update(['fcstatus'=>170]);//即将开始170
        //         }
                
        //         }else{
        //         if($ctimes >= 0 && $ctimes < 3600*24){
        //             model('second_house')->where(['id'=>$list[$key]['id']])->update(['fcstatus'=>169]);//正在进行
        //             // print_r($ctimes);echo "aaa";
        //             }elseif($ctimes >= (3600*24)){
        //             model('second_house')->where(['id'=>$list[$key]['id']])->update(['fcstatus'=>171]);//已结束171
        //              // print_r($ctimes);echo "aaa";
        //             }else{
        //             model('second_house')->where(['id'=>$list[$key]['id']])->update(['fcstatus'=>170]);//即将开始170
        //              // print_r($ctimes);echo "aaa";
