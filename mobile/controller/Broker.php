...

{
...

    {
...

        {
            ...
            $field = 'id,city,title,estate_id,estate_name,fcstatus,img,room,kptime,living_room,toilet,acreage,price,qipai,average_price,address,orientations,renovation,tags,marketprice';

            $second_lists = $secondObj->where($where)->field($field)->order('fcstatus asc')->limit(20)->select();
...
$this->assign('ids',$id);
...

    {
...

        {
            ...
            $field = 'id,fcstatus,city,title,estate_id,estate_name,img,room,living_room,toilet,acreage,price,average_price,address,orientations,renovation,tags,marketprice,fabutime';

            $lists = model('second_house')->where($where)->field($field)->order(['fcstatus' =>'asc','fabutime' =>'desc'])->paginate(20);
