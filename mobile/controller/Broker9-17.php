...

{
...

    {
        ...
        $field = 'u.id,u.nick_name,u.mobile,u.online_consulting,d.company,d.history_complate,d.service_area,d.tags,d.point,(FORMAT((d.point/5)*100,0)) as goods';
...

    {
...

        {
            ...
            $field = 'id,city,title,estate_name,fcstatus,img,room,living_room,toilet,acreage,price,average_price,address,orientations,renovation,tags,marketprice';
