...
$sls[] = ['city','in',$this->getCityChild($quyus)];
...
$this->assign('yjl',$yjl);
    ...
    public function getSecondLists()
    {
        ...
        // if($arr['cj']==175){
        //     $data    = $this->getListss($page);
        // }
        // if($arr['sort']==7){
        //     $data    = $this->getListsss($page);
        // }else{
        //     $data    = $this->getLists($page);
        // }
        ...
        foreach ($lists as $key => $value) {
               ...
               $lists[$key]['chajia']=round((substr($lists[$key]['price'],0,-10)-$lists[$key]['cjprice']),2);
...
$c1 = date('Y-01');
                ...
                $a1 = db('second_house')->field("sum(cjprice) as cjprices,sum(acreage) as acreages")->where($d1)->find();               

                $l1 = model('second_house')->where($d1)->count(); 

                // $dd1[] = ['endtime','like','$c1%'];

                //  $ld1 = model('second_house')->where($dd1)->count();
                 // print_r($ld1);
                ...
                if($l1==0){
                 ...
                 // $y1=round(($a1['cjprices']/$a1['acreages']),2);
                    $y1=sprintf("%.2f",($a1['cjprices']/$a1['acreages']));
                 // $y1=$a1['cjprices']/$l1;
                ...
                $a2 = db('second_house')->field("sum(cjprice) as cjprices,sum(acreage) as acreages")->where($d2)->find();

                $l2 = model('second_house')->where($d2)->count(); 

// $dd2[] = ['fcstatus','eq',175];

// $dd2[] = ['endtime','like',$c2.'%'];
//                 $ld2 = model('second_house')->where($dd2)->count();
//                 print_r($c2);
//                  print_r($ld2);
//                  echo "8";
                ...
                if($l2==0){
                 ...
                 $y2=sprintf("%.2f",($a2['cjprices']/$a2['acreages']));
                ...
                $a3 = db('second_house')->field("sum(cjprice) as cjprices,sum(acreage) as acreages")->where($d3)->find();

                $l3 = model('second_house')->where($d3)->count();     
                ...
                if($l3==0){
                 ...
                 $y3=sprintf("%.2f",($a3['cjprices']/$a3['acreages']));
                ...
                $a4 = db('second_house')->field("sum(cjprice) as cjprices,sum(acreage) as acreages")->where($d4)->find();

                $l4 = model('second_house')->where($d4)->count();      
                ...
                if($l4==0){
                 ...
                 $y4=sprintf("%.2f",($a4['cjprices']/$a4['acreages']));
                ...
                $a5 = db('second_house')->field("sum(cjprice) as cjprices,sum(acreage) as acreages")->where($d5)->find();

                $l5 = model('second_house')->where($d5)->count(); 
                ...
                if($l5==0){
                 ...
                 $y5=sprintf("%.2f",($a5['cjprices']/$a5['acreages']));
                ...
                $a6 = db('second_house')->field("sum(cjprice) as cjprices,sum(acreage) as acreages")->where($d6)->find();

                $l6 = model('second_house')->where($d6)->count();   
                ...
                if($l6==0){
                 ...
                 $y6=sprintf("%.2f",($a6['cjprices']/$a6['acreages']));
                ...
                $a7 = db('second_house')->field("sum(cjprice) as cjprices,sum(acreage) as acreages")->where($d7)->find();

                $l7 = model('second_house')->where($d7)->count();  
                ...
                if($l7==0){
                 ...
                 $y7=sprintf("%.2f",($a7['cjprices']/$a7['acreages']));
                ...
                $a8 = db('second_house')->field("sum(cjprice) as cjprices,sum(acreage) as acreages")->where($d8)->find();

                $l8 = model('second_house')->where($d8)->count(); 
                ...
                if($l8==0){
                 ...
                 $y8=sprintf("%.2f",($a8['cjprices']/$a8['acreages']));
                ...
                $a9 = db('second_house')->field("sum(cjprice) as cjprices,sum(acreage) as acreages")->where($d9)->find();

                $l9 = model('second_house')->where($d9)->count();    
                ...
                if($l9==0){
                 ...
                 $y9=sprintf("%.2f",($a9['cjprices']/$a9['acreages']));
                ...
                $d10[] = ['endtime','like',$c10.'%'];

                $d10[] = ['fcstatus','eq',175];

                $d10[] = ['estate_id','eq',$xiaoquid];

                $a10 = db('second_house')->field("sum(cjprice) as cjprices,sum(acreage) as acreages")->where($d10)->find();

                $l10 = model('second_house')->where($d10)->count();   
                ...
                if($l10==0){
                 ...
                 $y10=sprintf("%.2f",($a10['cjprices']/$a10['acreages']));
                ...
                $d11[] = ['endtime','like',$c11.'%'];

                $d11[] = ['fcstatus','eq',175];

                $d11[] = ['estate_id','eq',$xiaoquid];

                $a11 = db('second_house')->field("sum(cjprice) as cjprices,sum(acreage) as acreages")->where($d11)->find();

                $l11 = model('second_house')->where($d11)->count();  
                ...
                if($l11==0){
                 ...
                 $y11=sprintf("%.2f",($a11['cjprices']/$a11['acreages']));
                ...
                $d12[] = ['endtime','like',$c12.'%'];

                $d12[] = ['fcstatus','eq',175];

                $d12[] = ['estate_id','eq',$xiaoquid];

                $a12 = db('second_house')->field("sum(cjprice) as cjprices,sum(acreage) as acreages")->where($d12)->find();

                $l12 = model('second_house')->where($d12)->count(); 
                ...
                if($l12==0){
                 ...
                 $y12=sprintf("%.2f",($a12['cjprices']/$a12['acreages']));
...
// print_r($map);exit();
 ...
 // print_r($txq);
    ...
    private function getLists($page = 0)
    {
        ...
        $field   = "id,estate_id,title,city,iscj,fcstatus,estate_name,img,video,room,living_room,toilet,price,average_price,tags,address,acreage,orientations,renovation,update_time,fabutime,endtime,qipai,marketprice,cjprice,kptime,pano_url";
        $obj     = model('second_house');
...
//			
//			}
//			if((empty($where['fcstatus'])) && ($sort=='7')){
//				$obj     = $obj->where($where)->field($field)->order($this->getSort(7));
//			}
//			if((empty($where['fcstatus'])) && ($sort!='7') ){
//			
//				//$obj     = $obj->where($where)->field($field)->order($this->getSort(7));
...
//				$obj     = $obj->where($where)->field($field)->order($this->getSort($sort))->order(['fcstatus'=>'asc']);
//				
//				//$obj     = $obj->where($where)->field($field)->order($this->getSort($sort))->order(['kptime'=>'desc']);
//			
//			}
            ...
            if($page)
			{
				...
				//$lists = $obj->where('top_time','lt',$time)->page($page)->limit($this->pageSize)->order(['fabutime'=>'desc'])->select();
				...
				$result = $obj->where('top_time','lt',$time)->order('endtime','desc')->paginate($this->pageSize);
...
//
//                // print_r($page);exit();
//                // if($where['fcstatus']==175)
//                // {
//                //     $lists = $obj->where('fcstatus','eq',175)->page($page)->limit($this->pageSize)->select();
//                // }else{
//                //     $lists = $obj->where('top_time','lt',$time)->page($page)->limit($this->pageSize)->order(['fabutime'=>'desc'])->select();
//    
//                // }
...
// print_r($lists);
     ...
     * 获取seo信息
     */
    private function getSeo($lx){
        if ($lx == "18334"){//住宅
            $seo['title'] = '法拍房_司法拍卖房产_法拍房源_房产拍卖网_房拍网官方网站';
            $seo['keys']  = '法拍房,法拍网, 司法拍卖房产,拍卖网,房产拍卖网, 法拍房源';
            $seo['desc']  = '房拍网是专业的法拍房、司法拍卖房产、房屋拍卖信息平台，汇聚千余套低于市场价25%的优质法拍房源，可以便宜放心拍房。咨询电话400 677 0028';
        }elseif ($lx == '18333'){//商办
            $seo['title'] = '商业办公_司法拍卖房源_法拍房__房屋拍卖信息_房拍网房源';
            $seo['keys']  = '商业办公司法拍卖房源，商业办公法拍房，商业办公房屋拍卖信息';
            $seo['desc']  = '房拍网商业办公房源栏目汇聚千余套低于市场价25%的优质商业办公司法拍卖房产、法拍房源，丰富的房屋拍卖信息，可以便宜放心拍房，安心住新家。咨询电话400 677 0028';
        }elseif ($lx == '18331'){//别墅
            $seo['title'] = '别墅法拍卖房源_法拍房__房屋拍卖信息_房拍网房源';
            $seo['keys']  = '别墅司法拍卖房源，别墅法拍房，别墅房屋拍卖信息';
            $seo['desc']  = '房拍网别墅房源栏目汇聚千余套低于市场价25%的优质别墅司法拍卖房产、法拍房源，丰富的房屋拍卖信息，可以便宜放心拍房，安心住新家。咨询电话400 677 0028';
        }else{//平房.四合院
            $seo['title'] = '平房四合院司法拍卖房源_法拍房__房屋拍卖信息_房拍网房源';
            $seo['keys']  = '平房四合院司法拍卖房源，平房四合院法拍房，平房四合院房屋拍卖信息';
            $seo['desc']  = '房拍网平房四合院房源栏目汇聚千余套低于市场价25%的优质平房四合院司法拍卖房产、法拍房源，丰富的房屋拍卖信息，可以便宜放心拍房，安心住新家。咨询电话400 677 0028';
        }
