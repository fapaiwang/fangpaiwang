...
//zpend
    ...
    private function getLists($page = 0)
    {
        ...
        $field   = "id,title,city,iscj,estate_name,img,video,room,living_room,toilet,price,average_price,tags,address,acreage,orientations,renovation,update_time,qipai,marketprice";
        $obj     = model('second_house');
      // $where="iscj='159'";
