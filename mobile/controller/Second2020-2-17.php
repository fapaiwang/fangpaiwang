...
$c1 = date('Y-01');
                ...
                $a1 = db('second_house')->field("sum(cjprice) as cjprices")->where($d1)->find();               
                ...
                $a2 = db('second_house')->field("sum(cjprice) as cjprices")->where($d2)->find();
...
//                  echo "8";
                ...
                $a3 = db('second_house')->field("sum(cjprice) as cjprices")->where($d3)->find();
                ...
                $a4 = db('second_house')->field("sum(cjprice) as cjprices")->where($d4)->find();
                ...
                $a5 = db('second_house')->field("sum(cjprice) as cjprices")->where($d5)->find();
                ...
                $a6 = db('second_house')->field("sum(cjprice) as cjprices")->where($d6)->find();
                ...
                $a7 = db('second_house')->field("sum(cjprice) as cjprices")->where($d7)->find();
                ...
                $a8 = db('second_house')->field("sum(cjprice) as cjprices")->where($d8)->find();
                ...
                $a9 = db('second_house')->field("sum(cjprice) as cjprices")->where($d9)->find();
                ...
                $a10 = db('second_house')->field("sum(cjprice) as cjprices")->where($d10)->find();
                ...
                $a11 = db('second_house')->field("sum(cjprice) as cjprices")->where($d11)->find();
                ...
                $a12 = db('second_house')->field("sum(cjprice) as cjprices")->where($d12)->find();
