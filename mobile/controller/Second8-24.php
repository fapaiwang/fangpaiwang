...
// print_r($map);exit();
 ...
 // print_r($txq);
    ...
    private function getLists($page = 0)
    {
        ...
        $field   = "id,title,city,iscj,fcstatus,estate_name,img,video,room,living_room,toilet,price,average_price,tags,address,acreage,orientations,renovation,update_time,endtime,qipai,marketprice,cjprice,kptime,pano_url";
        $obj     = model('second_house');
      // $where="iscj='159'";
